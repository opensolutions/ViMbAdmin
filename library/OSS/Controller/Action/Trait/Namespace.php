...
/**
 * Controller: Action - Trait for Namespace
 *
 * @author     Barry O'Donovan <barry@opensolutions.ie>
 * @author     The Skilled Team of PHP Developers at Open Solutions <info@opensolutions.ie>
 * @category   OSS
 ...
 * @license    http://www.opensolutions.ie/licenses/new-bsd New BSD License
 */
trait OSS_Controller_Action_Trait_Namespace
{

    /**
     * A variable to hold the session namespace
     *
     * @var Zend_Session_Namespace An instance of the session namespace
     */
     ...
     */
    public function OSS_Controller_Action_Trait_Namespace_Init( $request, $response, $invokeArgs )
    {
        if( $this->traitIsInitialised( 'OSS_Controller_Action_Trait_Smarty' ) )
            $this->view->session = $this->getSessionNamespace();
    
        $this->traitSetInitialised( 'OSS_Controller_Action_Trait_Namespace' );
    }
