 ...
 * @license    http://www.opensolutions.ie/licenses/new-bsd New BSD License
 */
trait OSS_Controller_Action_Trait_Freshbooks
{
     ...
     */
    public function OSS_Controller_Action_Trait_Freshbooks_Init( $request, $response, $invokeArgs )
    {
        $this->traitSetInitialised( 'OSS_Controller_Action_Trait_Freshbooks' );
    }
     ...
     */
    protected function getFreshbooks(  )
    {
        if( $this->_freshbooks === null )
            $this->_freshbooks = $this->getBootstrap()->getResource( 'freshbooks' );
    
        return $this->_freshbooks;
