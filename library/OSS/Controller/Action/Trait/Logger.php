...
/**
 * Controller: Action - Trait for Logger
 *
 * @author     Barry O'Donovan <barry@opensolutions.ie>
 * @author     The Skilled Team of PHP Developers at Open Solutions <info@opensolutions.ie>
 * @category   OSS
...
trait OSS_Controller_Action_Trait_Logger
{
     ...
     *
     * @var Zend_Log An instance of the logger object
     */
     ...
     *
     * @return OSS_Log The Zend_Log object
     */
    public function getLogger()
    {
        if( $this->_logger === null )
        {
            // we may need the Mailer also...
            if( isset( $this->_options['ondemand_resources']['logger']['writers']['email'] ) )
                $this->getMailer();
    
            $plugin = new OSS_Resource_Logger( $this->getOptions()['ondemand_resources']['logger'] );
