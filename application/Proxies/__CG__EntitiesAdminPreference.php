 ...
 */
class AdminPreference extends \Entities\AdminPreference implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\AdminPreference' . "\0" . 'attribute', '' . "\0" . 'Entities\\AdminPreference' . "\0" . 'ix', '' . "\0" . 'Entities\\AdminPreference' . "\0" . 'op', '' . "\0" . 'Entities\\AdminPreference' . "\0" . 'value', '' . "\0" . 'Entities\\AdminPreference' . "\0" . 'expire', '' . "\0" . 'Entities\\AdminPreference' . "\0" . 'id', '' . "\0" . 'Entities\\AdminPreference' . "\0" . 'Preferences', '' . "\0" . 'Entities\\AdminPreference' . "\0" . 'Admin'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdminPreference $proxy) {
