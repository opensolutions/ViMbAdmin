...
/**
 * The form for adding and editing aliases additional info.
 *
 * @package ViMbAdmin
 * @subpackage Form
 */
class ViMbAdmin_Form_Alias_AdditionalInfo extends ViMbAdmin_Form_Plugin
{
    /**
    ...
    {
        $this->setDecorators( [ [ 'ViewScript', [ 'viewScript' => 'alias/form/additional-info.phtml' ] ] ] );
     ...
     */    
    public function createElements( $elements, $alias = null )
    {
        foreach( $elements as $name => $element )
        {
            ...
            if( $alias && $alias->getPreference( 'xpiInfo.' . $name ) )
                $element['options']['value'] = $alias->getPreference( 'xpiInfo.' . $name );
