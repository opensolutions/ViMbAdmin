...
class AliasPreference extends \Entities\AliasPreference implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\AliasPreference' . "\0" . 'attribute', '' . "\0" . 'Entities\\AliasPreference' . "\0" . 'ix', '' . "\0" . 'Entities\\AliasPreference' . "\0" . 'op', '' . "\0" . 'Entities\\AliasPreference' . "\0" . 'value', '' . "\0" . 'Entities\\AliasPreference' . "\0" . 'expire', '' . "\0" . 'Entities\\AliasPreference' . "\0" . 'id', '' . "\0" . 'Entities\\AliasPreference' . "\0" . 'Alias'];
        }
