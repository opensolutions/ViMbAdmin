 ...
 */
class DomainPreference extends \Entities\DomainPreference implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\DomainPreference' . "\0" . 'attribute', '' . "\0" . 'Entities\\DomainPreference' . "\0" . 'ix', '' . "\0" . 'Entities\\DomainPreference' . "\0" . 'op', '' . "\0" . 'Entities\\DomainPreference' . "\0" . 'value', '' . "\0" . 'Entities\\DomainPreference' . "\0" . 'expire', '' . "\0" . 'Entities\\DomainPreference' . "\0" . 'id', '' . "\0" . 'Entities\\DomainPreference' . "\0" . 'Domain'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DomainPreference $proxy) {
